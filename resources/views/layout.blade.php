    ...
    <div>
          ...
          <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
            <div class="container-fluid">
              <a class="navbar-brand " href="{{url('/truyen-hay')}}">
                <i class="fa fa-leanpub" style="margin-right: 10px" aria-hidden="true"></i>TRUYỆN TRANH 25h </a>
          ...
          <div style="margin-top: 15px">
            ...
            <div class="d-flex justify-content-between align-content-center m-4">
              <div class="col col-sm-10">Truyện Tranh 25h - Trang đọc truyện tranh hay với các thể loại đa dạng như Hành động, Trinh thám, Truyện Màu, Thiếu nhi. 
                Hiện tại trang đang thiếu kinh phí, mọi hỗ trợ hãy gửi vào ngân hàng - Mb - STK: 001231231230 - TRUONG DANG KHOA .</div>
